  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-full max-w-lg shadow-lg">
        <h2 className="text-xl font-bold mb-4">مشخصات هنرجوی صاحب اثر</h2>
        ...
        <div className="grid grid-cols-2 gap-4 text-right">
          ...
          <input name="facilitator_first_name" onChange={handleChange} placeholder="نام تسهیل‌گر" className="border p-2 rounded" />
          <input name="facilitator_last_name" onChange={handleChange} placeholder="نام خانوادگی تسهیل‌گر" className="border p-2 rounded" />
          <input name="facilitator_personnel_code" onChange={handleChange} placeholder="کد پرسنلی تسهیل‌گر" className="border p-2 rounded" />
